        ...
        'evolucao_mensal', (
            ...
            FROM (
                SELECT
                    ...
                    -- Calcular custo apenas para os planos que estavam ativos naquele mês
                    (
                        ...
                        -- Se há data de atualização do CNPJ, considerar como desativação
                        AND (c.updated_at IS NULL OR c.updated_at >= d.mes)
                    ) AS custo
