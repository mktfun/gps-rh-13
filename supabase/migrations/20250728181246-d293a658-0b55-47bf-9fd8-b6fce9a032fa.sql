...
-- Update the create_plano_v2 function to ensure it exists and matches the expected signature
...
-- Update the update_plano_v2 function to ensure it exists and matches the expected signature
