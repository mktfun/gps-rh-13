...
import { Plus, Search, Grid, List, Upload, Stethoscope } from 'lucide-react';
...
export default function PlanosSaudeEmpresasPage() {
  ...
  const { data: cnpjs = [], isLoading } = useCnpjsComPlanos({ 
    search,
    tipoSeguro: 'saude'
  });
  ...
  const handleCnpjClick = (cnpj: any) => {
    ...
    console.log('🎯 Rota correta:', `/corretora/planos-de-saude/${cnpj.empresa_id}`);
    navigate(`/corretora/planos-de-saude/${cnpj.empresa_id}`);
  };
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            Planos de Saúde - CENTRAL EMBALAGENS
          </CardTitle>
          <CardDescription>
            Gerencie os planos de saúde por CNPJ
          </CardDescription>
        </CardHeader>
